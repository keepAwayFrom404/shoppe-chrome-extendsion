 ...
 * Original file: /npm/opencc-js@1.0.4/data.js
 *
...
OpenCCJSData.JPShinjitaiCharacters = "両 兩|弁 辨|欠 缺|糸 絲|芸 藝|浜 濱";
...
OpenCCJSData.TWPhrasesOther = "元音 母音|冰棍 冰棒|出租車 計程車|咖喱 咖哩|塑料 塑膠|奔馳 賓士|奶酪 乳酪|幾率 機率|方便麪 泡麵|李彥宏 李彥宏|概率 機率|海內存知己 海內存知己|涼菜 冷盤|的士 計程車|砹 砈|硅 矽|程序不正義 程序不正義|程序正義 程序正義|空氣淨化器 空氣清淨機|納米 奈米|自行車 腳踏車|詞組 片語|蹦極 高空彈跳|輔音 子音|通過 透過|酰 醯|鈁 鍅|鈈 鈽|錇 鉳|鍀 鎝|鎄 鑀|鎇 鋂|鎿 錼|鐦 鉲|鑥 鎦|黃宏 黃宏|借記卡 簽帳金融卡";
